...
static const rt_un zz_expression_parser_binary_operators_precedence[] = {
 ...
 * </p>
 */
static rt_s zz_expression_parser_parse_number(struct zz_lexer *lexer, void **ast_nodes_list, struct zz_ast_node **result)
{
 ...
 */
static rt_s zz_expression_parser_parse_primary(struct zz_lexer *lexer, void **ast_nodes_list, struct zz_ast_node **result)
{
	struct zz_token *current_token = &lexer->current_token;
...
static rt_s zz_expression_parser_parse_binary_operator(struct zz_lexer *lexer, rt_un parent_operator_precedence, struct zz_ast_node *left_hand_side, void **ast_nodes_list, struct zz_ast_node **result)
{
	...
	while (RT_TRUE) {
		...
		current_operator_precedence = zz_expression_parser_binary_operators_precedence[current_operator];
